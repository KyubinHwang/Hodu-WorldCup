...
const items = [
    ...
    {
        name : "돌담 위 카리스마 호두",
        src : require("./img/IMG_1279.JPG")
    },
    {
        name : "텐트 속 호두",
        src : require("./img/IMG_1286.JPG")
    },
    {
        name : "미용 후 지긋 호두",
        src : require("./img/IMG_1345.JPG")
    },
    {
        name : "호시탐탐 호두",
        src : require("./img/IMG_1401.jpg")
    },
    {
        name : "지친 호두",
        src : require("./img/IMG_1402.jpg")
    },
    {
        name : "아련한 호두",
        src : require("./img/IMG_1421.jpg")
    },
    {
        name : "애교부리는 호두",
        src : require("./img/IMG_1425.jpg")
    },
    {
        name : "잔디 속 호두",
        src : require("./img/IMG_1862.jpg")
    },
    {
        name : "꿀잠 호두",
        src : require("./img/IMG_1979.jpg")
    },
    {
        name : "호다닥 호두",
        src : require("./img/IMG_2291.jpg")
    },
    {
        name : "뀨? 호두",
        src : require("./img/IMG_2303.JPG")
    },
    {
        name : "두려워 견제 중 호두",
        src : require("./img/IMG_2361.jpg")
    },
    {
        name : "꼬순 내 호두",
        src : require("./img/IMG_2426.JPG")
    },
    {
        name : "양말 신은 호두",
        src : require("./img/IMG_2562.jpg")
    },
    {
        name : "귀찮은 호두",
        src : require("./img/IMG_2602.JPG")
    },
    {
        name : "공 묘기 호두",
        src : require("./img/IMG_2663.JPG")
    },
];
...
function VsPage32(){
    ...
    const [totalRound, setTotal] = useState(16);
